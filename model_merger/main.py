...
def main():
    classification_interpreter = tf.keras.models.load_model("../layered_model")
    object_detection_interpreter = tf.keras.models.load_model("../object_detection_models/ssd_mobilenet_v2_fpnlite_640x640_coco17_tpu-8")

    input_image = tf.keras.layers.Input(shape=(640, 640, 3), name='image_input')
    detection_results = object_detection_interpreter(input_image)
